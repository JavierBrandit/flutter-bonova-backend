...
const { editar, guardarCurso, verGuardados, eliminarGuardado, agregarHistorial, borrarHistorial, searchCursos, guardarHistorial } = require('../contollers/auth_controller');
...
router.get('/historial', validarJWT, obtenerGuardado ), 
